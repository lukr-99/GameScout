...
namespace FreeGameScout.App.Services;

/// <summary>
/// Registers (or removes) FreeGameScout in the per-user Windows "Run" key so it launches at sign-in.
...
public sealed class StartupRegistration
{
    ...
    /// <param name="valueName">The registry value name to use; defaults to "FreeGameScout".</param>
    public StartupRegistration(string valueName = "FreeGameScout")
    {
